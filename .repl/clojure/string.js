...
{var pred__7391 = cljs.core._EQ_;var expr__7392 = limit;if(pred__7391.call(null,1,expr__7392))
{return cljs.core.vector.call(null,s);
} else
{if(pred__7391.call(null,2,expr__7392))
{return cljs.core.vector.call(null,"",s);
} else
...
{var ch = s.charAt(index);var temp__4090__auto___7398 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___7398))
{var replacement_7399 = temp__4090__auto___7398;buffer.append([cljs.core.str(replacement_7399)].join(''));
} else
{buffer.append(ch);
}
{
